...
WebUI.setText(findTestObject('Object Repository/Cambio de contraseña/Page_Gastiganto/input_Nueva contrasea_form-control form-con_18c268'), 
    GlobalVariable.password)

WebUI.setText(findTestObject('Object Repository/Cambio de contraseña/Page_Gastiganto/input_Confirmar contrasea_form-control form_972848'), 
    GlobalVariable.password)
